...
from optimizer_zoo import create_trainer, create_optimizer, AsyncTrainingArguments
...
parser = HfArgumentParser((ScriptArguments, AsyncTrainingArguments))
script_args, training_args = parser.parse_args_into_dataclasses()
training_args.task = "sft" # double ensure the trainer builder understand it's a sft task
...
trainer = create_trainer(training_args)(
    ...
    tokenizer=tokenizer,
    args=training_args,
    optimizers=create_optimizer(base_model, training_args)
)
trainer.train()
