...
from optimizer_zoo import create_optimizer, create_trainer, AsyncSeq2SeqTrainingArguments
...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, AsyncSeq2SeqTrainingArguments))
    ...
    trainer = create_trainer(training_args=training_args)(
        ...
        optimizers = create_optimizer(model, training_args=training_args)
    )
